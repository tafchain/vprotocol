...
CCcJsonDemoService::CCcJsonDemoService()
{
}

CCcJsonDemoService::CSession::CSession(CCcJsonDemoService& rCcDemoService)
	: m_rCcService(rCcDemoService)
{

}

ACE_INT32 CCcJsonDemoService::OnInit(void)
{
...
ACE_INT32 CCcJsonDemoService::OnExit(void)
{
	return CCcJsonService::OnExit();
}

ACE_INT32 CCcJsonDemoService::OnPorposal(const ACE_UINT32 nSessionID, CTestDemoTrade& rTestDemoTrade)
{
...
void CCcJsonDemoService::OnGetVbhUserRsp(const ACE_INT32 nReturnCode, const ACE_UINT32 nSessionID, CSimpleUser& rUser)
{
...
void CCcJsonDemoService::OnTimeOut(CSession* pUserSession)
{
