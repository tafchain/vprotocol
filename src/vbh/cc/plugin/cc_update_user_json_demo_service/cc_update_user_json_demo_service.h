#ifndef CC_UPDATE_USER_JSON_DEMO_SERVICE_H_3428723472314231213863217
#define CC_UPDATE_USER_JSON_DEMO_SERVICE_H_3428723472314231213863217
...
class PLUGIN_EXPORT CCcUpdateUserJsonDemoService : public CCcJsonService
{
public:
	enum
	{
		...
		EN_SERVICE_TYPE = CC::EN_CC_UPDATE_USER_JSON_DEMO_SERVICE_TYPE
	};

	class CSession : public CDscServiceTimerHandler
	{
	public:
		CSession(CCcUpdateUserJsonDemoService& rCcDemoService);
	...
	protected:
		CCcUpdateUserJsonDemoService& m_rCcService;
	};

public:
	CCcUpdateUserJsonDemoService();
...
public:
	...
	BIND_JSON_PROPOSAL_PROC(CTestUpdateUser)
...
#include "cc_update_user_json_demo_service/cc_update_user_json_demo_service.inl"
