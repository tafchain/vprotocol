...
ifeq ($(release),1)
  ...
  #CC_FLAG += -DDONNT_USING_MEMORY_POOL -g -fstack-protector -fno-inline -fno-default-inline  -fno-strict-aliasing -fsanitize=address -fsanitize=leak
  CC_FLAG += -DDONNT_USING_MEMORY_POOL -DUSING_DSC_LOG_BIN -g -fstack-protector -fno-inline -fno-default-inline
endif
